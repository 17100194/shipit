...
<head>
    ...
    <title><?php echo e(config('app.name', 'Shipit')); ?></title>
    ...
    <!-- Plugins -->
    <link rel="stylesheet" type="text/css" href="<?php echo e(asset('css/plugins-css.css')); ?>" />
    ...
    <!-- Skin -->
    <link rel="stylesheet" type="text/css" href="<?php echo e(asset('css/skins/skin-blue.css')); ?>" />
</head>
<body>
<div class="wrapper">
                        ...
                        <div class="container">
                            <div class="row">
                                <div class="col-lg-12 col-md-12">
                                    ...
                                    <ul class="menu-logo">
                                        <li>
                                            <a href="<?php echo e(url('/')); ?>" style="font-size: 30px;"><img id="logo_img" src="<?php echo e(asset('images/logo.png')); ?>" alt="logo"></a>
                                        </li>
                                    </ul>
                                    <!-- menu links -->
                                    <div class="menu-bar">
...
<!-- jquery -->
<script type="text/javascript" src="<?php echo e(asset('js/jquery-1.12.4.min.js')); ?>"></script>

<!-- plugins-jquery -->
<script type="text/javascript" src="<?php echo e(asset('js/plugins-jquery.js')); ?>"></script>

<!-- plugin_path -->
<script type="text/javascript">var plugin_path = '<?php echo e(url('js')); ?>/';</script>
